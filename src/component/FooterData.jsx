...
export const footerInfo = [
    {icon: faBuffer, info1: 'ECS', id: 1},
    {icon: faMobileAlt, info1: '+1234567890', info2: 'test@gmail.com', id: 2},
    {icon: faMapMarkedAlt, info1: 'Amsterdam, Netherlands', info2: 'Amsterdam, Netherlands', id: 3}
];